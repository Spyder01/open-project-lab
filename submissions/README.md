...
Here you'll find all the **real-world implementations** built from ideas in the [Open Project Lab](../README.md).
...
3. Add your project entry using the **implementation template**:
   ...
   Follow the format in [implementation-template.md](../templates/implementation-template.md):
...
| --------------------------- | -------------------------------------------------------------------- | ------------------------------------------- |
| 🌐 **Web Development**      | Websites, APIs, frontends, full-stack apps.                          | [View Submissions →](web.md)                |
| 🤖 **AI / ML**              | Models, LLM tools, chatbots, and AI projects.                        | [View Submissions →](ai-ml.md)              |
| ⚙️ **Systems & Tools**      | Low-level systems, utilities, CLI tools, and backend infrastructure. | [View Submissions →](systems.md)            |
| 🌐 **Networks & Protocols** | Networking tools, protocol analyzers, and communication systems.     | [View Submissions →](networks-protocols.md) |
| 🎮 **Game Development**     | 2D / 3D games, engines, and experiments.                             | [View Submissions →](game-dev.md)           |
| 🧩 **Miscellaneous**        | Creative, experimental, or hybrid ideas.                             | [View Submissions →](misc.md)               |
...
* Each entry must be linked to an **idea** listed in the relevant [`categories/`](../categories/) section.
